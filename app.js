  ...
  windowTypes.forEach((type, index) => {
    ...
    card.innerHTML = `
      ...
      <div class="type-meta">
        ...
        <span class="meta-pill">Gå tid: ${formatSeconds(type.walkSeconds)} / hver ${toNumber(type.walkEveryCount || 1)} rude(r)</span>
      </div>
    `;
...
async function handleTypeSubmit(event) {
  ...
  const payload = {
    ...
    walkEveryCount: Math.min(12, Math.max(1, toNumber(els.typeWalkEveryCount.value || 1))),
